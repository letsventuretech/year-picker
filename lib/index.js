...
require('./node_modules/element-closest');
...
var YearPicker = function (_Component) {
  ...
  function YearPicker(props) {
    ...
    _this.state = {
      currentYear: _this.props.selected ? +_this.props.selected : '',
      yearIsSelected: false,
      selectedYear: _this.props.selected ? +_this.props.selected : new Date().getFullYear(),
      panelIsOpen: false,
      panelTop: 0,
      panelLeft: 0
    };
